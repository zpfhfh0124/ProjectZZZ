...
#include "BasicDamageCalculation.h"
...
struct DamageStatics
{
	...
	DamageStatics()
	{
		DEFINE_ATTRIBUTE_CAPTUREDEF(UBossCharacterStatus, _attackPoint, Source, false);
		DEFINE_ATTRIBUTE_CAPTUREDEF(UBossCharacterStatus, _defencePoint, Target, false);
		DEFINE_ATTRIBUTE_CAPTUREDEF(UBossCharacterStatus, _health, Target, false);
	}
};
...
UBasicDamageCalculation::UBasicDamageCalculation()
{
...
void UBasicDamageCalculation::Execute_Implementation(const FGameplayEffectCustomExecutionParameters& ExecutionParams,
                                                     FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	UE_LOG(LogTemp, Error, TEXT("공격 받았습니다. 대미지 비율 %f"), damageRate);
